...
replace (
	...
	github.com/btcsuite/btcwallet => github.com/breez/btcwallet v0.16.6-p2wsh-legacy
	...
	github.com/lightningnetwork/lnd => github.com/breez/lnd v0.15.0-beta.rc6.0.20230220112557-e49d37fcd581
)
